...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(sistema.agregarOperacion2(LocalDate.of(2024, 3, 1),  (Venta) sistema.traerInmueble(1), "Alta inmueble para la venta", 0f));
		...
		System.out.println(sistema.agregarOperacion2(LocalDate.of(2024, 3, 1),  (Venta) sistema.traerInmueble(3), "Alta inmueble para la venta", 0f));
		...
		System.out.println(sistema.agregarOperacion2(LocalDate.of(2024, 3, 1),  (Venta) sistema.traerInmueble(5), "Alta inmueble para la venta", 0f));
		...
		System.out.println(sistema.agregarOperacion2(LocalDate.of(2024, 10, 16), (Venta) sistema.traerInmueble(1), "vendido",(float)(((Venta) sistema.traerInmueble(1)).getPrecioVenta())) );
		System.out.println(sistema.getLstOperacion());
		System.out.println("------------");
